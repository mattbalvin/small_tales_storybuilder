...
<div class="h-full flex">
  ...
  <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
    <!-- Zoom Controls -->
    <div class="flex items-center justify-between p-3 border-b bg-soft-buttercream flex-shrink-0">
      <div class="flex items-center gap-2">
        <button
          class="px-3 py-1 text-sm bg-background border border-periwinkle-blue/30 rounded-lg hover:bg-periwinkle-blue/10 text-dusty-teal"
          role="button"
        ...
        <span class="text-sm font-mono min-w-[60px] text-center text-dusty-teal">
    ...
    <div 
      ...
      class="flex-1 overflow-hidden bg-periwinkle-blue/5 relative"
      role="application"
      tabindex="0"
      ...
      >
        {#each sortedElements as element (element.id)}
          <div
            ...
            class:border-3={selectedElementId === element.id && !readonly}
            class:border-golden-apricot={selectedElementId === element.id && !readonly}
          ...
          >
            ...
            {#if selectedElementId === element.id && !readonly && !isAltPressed}
              <div 
                class="resize-handle absolute w-5 h-5 bg-golden-apricot border border-white rounded-full cursor-nw-resize hover:scale-125 transition-transform shadow-md" 
                style="left: -8px; top: -8px; z-index: 20;"
                data-handle="nw"
                role="button"
                tabindex="0"
              ></div>
              <div 
                class="resize-handle absolute w-5 h-5 bg-golden-apricot border border-white rounded-full cursor-ne-resize hover:scale-125 transition-transform shadow-md" 
                style="right: -8px; top: -8px; z-index: 20;"
                data-handle="ne"
                role="button"
                tabindex="0"
              ></div>
              <div 
                class="resize-handle absolute w-5 h-5 bg-golden-apricot border border-white rounded-full cursor-sw-resize hover:scale-125 transition-transform shadow-md" 
                style="left: -8px; bottom: -8px; z-index: 20;"
                data-handle="sw"
                role="button"
                tabindex="0"
              ></div>
              <div 
                class="resize-handle absolute w-5 h-5 bg-golden-apricot border border-white rounded-full cursor-se-resize hover:scale-125 transition-transform shadow-md" 
                style="right: -8px; bottom: -8px; z-index: 20;"
                data-handle="se"
                role="button"
                tabindex="0"
              ></div>
        ...
        {#if displayElements.length === 0}
          <div class="absolute inset-0 flex items-center justify-center text-dusty-teal pointer-events-none">
        ...
        <!-- Readonly overlay -->
        {#if readonly}
          <div class="absolute top-3 right-3 px-3 py-1 bg-periwinkle-blue/70 rounded-lg text-sm text-white">
            Read-only
          </div>
        {/if}
      </div>
...
<style>
  ...
  .overflow-auto::-webkit-scrollbar-track {
    background: hsl(var(--periwinkle-blue) / 0.1);
    border-radius: 4px;
  }
  ...
  .overflow-auto::-webkit-scrollbar-thumb:hover {
    background: hsl(var(--periwinkle-blue) / 0.5);
  }
</style>