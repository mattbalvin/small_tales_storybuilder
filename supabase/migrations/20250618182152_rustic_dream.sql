/*
  ...
  2. Security
    ...
    - User-specific policies for profile and media management
    - Public read access for stories and pages
    - Authenticated user policies for content creation

  3. Storage
    - Media bucket for file uploads
    - User-specific folder structure
    - Public read access with authenticated upload/modify
