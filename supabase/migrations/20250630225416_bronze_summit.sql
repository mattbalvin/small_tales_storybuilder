/*
  ...
  1. New Storage Bucket
    - Creates a 'media' storage bucket for user uploads
    - Sets the bucket as public for easy access

  2. Security
    - Adds policies to control access to media files
    - Ensures users can only manage their own files
    - Allows public read access for story sharing
*/
